...
Hi! I'm currently a Master's student at the [IIAU-Lab](https://iiaulab.github.io/), Dalian University of Technology, advised by [Prof. Xu Jia](https://stephenjia.github.io/). My research interests focus on image and video generation, particularly in generative models and visual content synthesis.
...
<!-- <div class='paper-box'><div class='paper-box-image'><div><div class="badge">CVPR 2026 Findings</div><img src='images/' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[Video2LoRA: Unified Semantic-Controlled Video Generation via Per-Reference-Video LoRA](https://arxiv.org/pdf/2603.08210)

Zexi Wu, Qinghe Wang<sup>✉</sup>, Yiming Zhang, Jing Dai, Baolu Li, Yiming Zhang, Yue Ma<sup>✉</sup>, Xu Jia, Hongming Xu<sup>✉</sup>.

<sup>✉</sup>Corresponding Author

<!-- [**Project**](https://scholar.google.com/citations?view_op=view_citation&hl=zh-CN&user=DhtAFkwAAAAJ&citation_for_view=DhtAFkwAAAAJ:ALROH1vI_8AC) <strong><span class='show_paper_citations' data='DhtAFkwAAAAJ:ALROH1vI_8AC'></span></strong>
- Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ornare aliquet ipsum, ac tempus justo dapibus sit amet.  -->
[[**Paper**](https://arxiv.org/pdf/2603.08210)]
